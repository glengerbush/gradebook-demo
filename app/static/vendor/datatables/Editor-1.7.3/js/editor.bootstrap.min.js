...
function(){c.each(a.s.fields,function(b,a){c("input:not([type=checkbox]):not([type=radio]), select, textarea",a.node()).addClass("form-control")})});return b},open:function(a,e,d){if(b._shown)d&&d();else{b._dte=a;b._shown=true;a=b._dom.modalContent;a.children().detach();a.append(e);c("div.modal-header",e).prepend(b._dom.close);c(b._dom.content).one("shown.bs.modal",function(){b._dte.s.setFocus&&b._dte.s.setFocus.focus();d&&d()}).one("hidden",function(){b._shown=false}).appendTo("body").modal({backdrop:"resources",
